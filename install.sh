...
echo -e "${DIM}This email will automatically be granted the PLATFORM ADMIN role upon signup/login.${NC}"
read -r -p "   Platform Admin Email (e.g. admin@yourdomain.com): " PLATFORM_ADMIN_EMAIL
